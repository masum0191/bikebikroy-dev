...
@section('content')
                ...
                <div class="col-md-10">
                    <div class="banner-item text-center">
                        ...
                        <form action="{{ url('searchbike') }}" method="get" class="d-flex banner-src-form">
                            <input class="form-control banner-src-box" type="search" name="keyword"
                        ...
                        <div class="container-fluid">
                            <form class="d-flex m-auto">
                                <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search"
                                    style="width: 800px;">
                                <button class="btn btn-warning text-white" style="font-weight: 700;"
                        ...
                        <div class="col-md-3">
                            <div class="card ad-card-single border mb-0">
                                <a href="{{ url('bikesale/' . $bike1->slug) }}">
                                    <img src="{{ url('storage/app/files/shares/uploads/' . $bike1->path . '/' . $bike1->photoone) }}"
                                        class="w-100 bike-post-list" height="150px" width="225px;" alt="{{ $bike1->title }}"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text mb-0">{{ @$bike1->thana->thana }},
                                            {{ @$bike1->district->district }}, {{ @$bike1->division->division }} </p>
                        ...
                        <div class="col-md-3">
                            <div class="card ad-card-single border mb-0">
                                <a href="{{ url('bikesale/' . $bike2->slug) }}">
                                    <img src="{{ url('storage/app/files/shares/uploads/' . $bike2->path . '/' . $bike2->photoone) }}"
                                        class="w-100 bike-post-list" height="150px" width="225px;"
                                        alt="{{ $bike2->title }}" style="object-fit: cover;">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                        ...
                                        <p class="card-text mb-0">{{ @$bike2->thana->thana }},
                                            {{ @$bike2->district->district }}, {{ @$bike2->division->division }} </p>
                        ...
                        <div class="col-md-3">
                            <div class="card ad-card-single border mb-0">
                                <a href="{{ url('bikesale/' . $bike3->slug) }}">
                                    <img src="{{ url('storage/app/files/shares/uploads/' . $bike3->path . '/' . $bike3->photoone) }}"
                                        class="w-100 bike-post-list" height="150px" width="225px;"
                                        alt="{{ $bike3->title }}" style="object-fit: cover;">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            @if (Str::of($bike3->title)->wordCount() > 2)
                                                {{ substr($bike3->title, 0, 30) . '...' }}
                                            @else
                                                {{ substr($bike3->title, 0, 20) . '...' }} &#160 &#160 &nbsp &#160 &#160
                                                &#160 &#160.
                                            @endif
                                        ...
                                        <a href="{{ url('bikebrand/' . $brand->slug) }}">
                                            <div class="single-category">
                                                <div class="cat-icon align-self-center">
                                                    <img src="{{ $brand->photo }}" alt="{{ $brand->bikebrand }}"
                                                        class="img-fluid">
                                                </div>
    ...
    font-size: larger;
    border-radius: 5px;"
                                class="bg-danger" type="button" id="load" data-bs-toggle="collapse"
                                ...
                                <div class="start-marketing-icon">
                                    <svg viewBox="0 0 119 126" class="svg-wrapper--8ky9e">
                                        <g fill="none" fill-rule="evenodd">
                                            <ellipse fill="#F3F6F5" cx="58.904" cy="66.658" rx="58.904"
                                                ry="59.342"></ellipse>
                                            <g fill-rule="nonzero">
                                                <path
    ...
    <section id="quick-link">
        <div class="container">
            ...
            <p>BikeBikroy.com is a dedicated online platform in Bangladesh, exclusively designed for motorcycle enthusiasts.
                It serves as a comprehensive classified website focusing on the motorcycle market, offering a centralised
                hub for buying and selling motorcycles, accessories, and gears. Whether you're looking to explore the latest
                bike models or connect with fellow riders, BikeBikroy.com provides a one-stop solution for all things
                related to motorcycles.</p>

            <h4>What kind of services does BikeBikroy.com provide?</h4>

            <p>BikeBikroy.com provides a range of services tailored to the motorcycle market in Bangladesh. These services
                include:</p>

            <ul>
                <li>Classified Listings: Users can buy or sell new and used motorcycles through detailed classified ads.
                </li>
                <li>Accessories and Gears: A diverse marketplace for motorcycle accessories and gears to enhance the riding
                    experience.</li>
                <li>Comprehensive Categories: Coverage of every category within the motorcycle niche, catering to various
                    preferences and needs.</li>
                <li>Community Connection: A platform for riders to connect, share experiences, and stay updated on the
                    latest trends in the motorcycle community.</li>
            </ul>
            <br />
            <h4>Benefits of shopping at BikeBikroy.com:</h4>

            <p>Effortless Shopping Experience: Enjoy a streamlined and secure shopping journey in Bangladesh with
                BikeBikroy.com. Our user-friendly interface ensures a fast and easy process, allowing you to find your
                desired products with just a few clicks.</p>

            <p>Free Ad Posting: Experience the freedom to showcase your products or services without any cost.
                BikeBikroy.com is a free classifieds website, providing users the opportunity to post ads across various
                categories based on their location, ensuring maximum convenience.</p>

            <p>Safety Assurance: Shop with confidence at BikeBikroy.com. We prioritise your safety by featuring verified
                members and authorised dealers. Rest assured, your online transactions are secure, making your shopping
                experience with us trustworthy and worry-free.</p>
