...
@section('title','Bike Sale Update')
@section('page-style')
        ...
        <div class="row">
            <div class="col-md-12">
                <h3 class="ad-post-head mb-0 pt-5 text-center">
                    Welcome {{Auth::user()->fullname}} Let's post Updating .
                </h3>
            </div>
        </div>
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="ad-form">
                          {!! Form::model($bikesale, ['url' => 'user/updatebikesales/'.$bikesale->id, 'class' => 'row g-3', 'files' => true]) !!}
                        <div class="col-md-12">
                      ...
                      <div class="col-md-4">
                          ...
                          {{--  <div class="col-md-6">
                            ...
                            <div class="col-12">
                                ...
                                {!! Form::text('manufacture',null,   array('id'=>'manufacture','class'=>'form-control','placeholder'=>'Ex: When was your bike manufactured?')) !!}
                               </div>
                               <div class="col-12">
                            ...
                            <div class="col-3">
                                ...
                                <img id="preview1" src="{{@url('storage/app/files/shares/uploads/'.$bikesale->path.'/'.$bikesale->photoone)}}"
                            ...
                            <div class="col-3">
                                ...
                                <img id="preview2" src="{{@url('storage/app/files/shares/uploads/'.$bikesale->path.'/'.$bikesale->phototwo)}}"
                                alt="preview image" style="max-height: 250px;">
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                                ...
                                <img id="preview3" src="{{@url('storage/app/files/shares/uploads/'.$bikesale->path.'/'.$bikesale->photothree)}}"
                                alt="preview image" style="max-height: 250px;">
                            </div>
                            ...
                            <div class="col-3">
                                ...
                                <img id="preview4" src="{{@url('storage/app/files/shares/uploads/'.$bikesale->path.'/'.$bikesale->photofour)}}"
                                alt="preview image" style="max-height: 250px;">
                            </div>
                            ...
                            <table class="table table-bordered" id="dynamic_field">
                                ...
                                <tr>
                                    ...
                                    <td><input type="tel" required name="phonenumber" value="{{Auth::user()->phone}}" placeholder="phone number *" class="form-control name_list" /><span id="error" class="text-danger"></span></td>
...
if($(this).val().length==10){
    ...
    var thanaid = '{!! $bikesale->thana_id !!}';
    var areaid = '{!! (auth()->user()->area_id) !!}';
    var bikemodelid = '{!! $bikesale->bikemodel_id !!}';
