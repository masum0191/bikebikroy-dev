                            ...
                            <div class="users-container">
                                ...
                                <ul class="users chat-users">
                                    ...
                                    <li class="person" data-chat="person{{$loop->index}}">
                                        <a href="{{url('user/chat/'.$chats->bikesale_id)}}">
                                            @php
                                            $userinfos=\App\Models\User::select('photo','path','fullname')->find(@$chats->bikesaler_id);
                                                  @endphp
                        ...
                        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-9 col-9">
                            ...
                            <div class="chat-container">
                                <ul class="chat-box chatContainerScroll">
                                    @foreach (@$Singlechat->bikesalechatdetails as $chat)
                                    ...
                                    <li class="chat-right">
                                        ...
                                        <div class="chat-text">{{$chat->message}}</div>
                                        <div class="chat-avatar">
                                            <img src="{{url('storage/app/files/shares/uploads/'.@Auth::user()->path.'/'.@Auth::user()->photo)}}" alt="No-Photo">
                                            <div class="chat-name">{{@$chat->messageby}}</div>
                                        </div>
                                    </li>
                                    @endif
