                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-3 col-3">
                            <div class="users-container">
                                ...
                                <ul class="users chat-users">
                                    ...
                                    @if (Auth::id() !==@$chat->chatuser_id)
                                  <li class="person" data-chat="person{{$loop->index}}">
                                        <a href="{{url('user/newuserchat/'.$chats->user_id)}}">
                                            @php
                                            $userinfos=\App\Models\User::select('photo','path','fullname','id')->find(@$chats->chatuser_id);
                                 ...
                                 <ul class="chat-box chatContainerScroll">
                                     ...
                                     <li class="chat-left">
                                         <div class="chat-avatar">
                                          @php
                                        $userinfo=\App\Models\User::select('photo','path')->find(@$chat->chatuser_id);
                                              @endphp
                                         ...
                                         <div class="chat-hour">{{$chat->created_at->diffForHumans()}} <span class="fa fa-check-circle"></span></div>
                                     </li>
                                     @else
                                     <li class="chat-right">
                                         <div class="chat-hour">{{$chat->created_at->diffForHumans()}} <span class="fa fa-check-circle"></span></div>
                                     ...
                                     @endif
                                     @endforeach
                                     <input type="hidden" id="chatuser_id" value="{{ Request::segment(3) }}">
                                 </ul>
