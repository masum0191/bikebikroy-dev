    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            {!! Form::open(['url' => 'superadmin/createarea', 'class' => 'form', 'id' => 'ccccc']) !!}
                {!! Form::hidden('areaid', '', ['id' => 'areaid']) !!}
               <label for="district" class="form-label">Select Thana *</label>
            <div class="input-group">
                {!!Form::select('thana_id',CommonFx::Thananame(),null, array('id'=>'thana_id','required','class'=>'form-control','placeholder'=>'Select Thana'))!!}
            </div>   
            <label for="areaname" class="form-label">Area Name English *</label>
              <div class="input-group">
                {!! Form::text('areaname', null, ['id' => 'areaname', 'class' => 'form-control  mb-1']) !!}
            </div> 
            <label for="bnareaname" class="form-label">Area Name Bangla *</label>
            <div class="input-group">
                {!! Form::text('bnareaname', null, ['id' => 'bnareaname', 'class' => 'form-control  mb-1']) !!}
            </div> 
                </div>
