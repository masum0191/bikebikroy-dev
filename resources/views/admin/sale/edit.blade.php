...
<div class="row">
    @include('partial.formerror')
            {!! Form::model($info, ['url' => 'admin/updatebikesale/'.$info->id, 'class' => 'row g-3','enctype'=>'multipart/form-data', 'files' => true]) !!}
         <div class="col-md-6">
        {!! Form::label('user_id', 'Select User *') !!}
        {!! Form::select('user_id', $users->pluck('fullname', 'id'), null, ['class' => 'form-control js-example-basic-single', 'required' => true]) !!}
    </div>
        <div class="col-md-6">
            {!! Form::label('phonenumber', 'Number *') !!}
            {!! Form::tel('phonenumber',null,   array('id'=>'phonenumber',$info->phonenumber,'required','class'=>'form-control','placeholder'=>'Ex: Bike Saler Phone Numer')) !!}
                         ...
                         <div class="col-md-4">
                           ...
                           {{-- <div class="col-md-6">
                            ...
                            <div class="col-3">
                                ...
                                <img id="preview1" src="{{@url('storage/app/files/shares/uploads/'.$info->path.'/'.$info->photoone)}}"
                            ...
                            <div class="col-3">
                                ...
                                <img id="preview2" src="{{@url('storage/app/files/shares/uploads/'.$info->path.'/'.$info->phototwo)}}"
                                alt="preview image" style="max-height: 250px;">
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                                ...
                                <img id="preview3" src="{{@url('storage/app/files/shares/uploads/'.$info->path.'/'.$info->photothree)}}"
                                alt="preview image" style="max-height: 250px;">
                            </div>
                            ...
                            <div class="col-3">
                                ...
                                <img id="preview4" src="{{@url('storage/app/files/shares/uploads/'.$info->path.'/'.$info->photofour)}}"
                                alt="preview image" style="max-height: 250px;">
                            </div>
