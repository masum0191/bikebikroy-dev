                ...
                <div class="modal-body">
                    ...
                    <div class="md-3">
                        ...
                        {!! Form::tel('phonenumber', null, [
                            ...
                            'required',
                            'class' => 'form-control',
                            'placeholder' => 'Ex: Bike Saler Phone Numer',
                        ]) !!} </div>
                    {{-- <div class="md-3">
                    ...
                    <div class="col-12">
                        ...
                        {!! Form::text('manufacture', null, [
                            'id' => 'manufacture',
                            'class' => 'form-control',
                            'placeholder' => 'Ex: Year of Manufacture?',
                        ]) !!}
                    </div>
                    <div class="col-12">
                        ...
                        {!! Form::number('year', null, [
                            ...
                            'required',
                            'class' => 'form-control',
                            'placeholder' => 'Ex: What was your bike Buy Year ?',
                        ]) !!}
                    </div>
                    <div class="col-md-6">
                        {!! Form::label('kilometerrun', 'Kilometers run (km) *') !!}
                        {!! Form::number('kilometerrun', null, [
                            'id' => 'kilometerrun',
                            'required',
                            'class' => 'form-control',
                            'placeholder' => 'Ex: What is the mileage of your bike?',
                        ]) !!}
                    ...
                    <div class="col-md-6">
                        ...
                        {!! Form::number('cc', null, [
                            ...
                            'required',
                            'class' => 'form-control',
                            'placeholder' => 'Ex: What is the engine capacity of your bike?',
                        ]) !!}
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-12">
                        ...
                        {!! Form::number('price', null, [
                            ...
                            'class' => 'form-control',
                            'min' => '1',
                            'placeholder' => 'Ex: Pick a good price - what would you pay?',
                        ]) !!}
                    </div>
                    <div class="mb-3">
                        ...
                        {!! Form::select(
                            ...
                            [
                                ...
                                'productaproved' => 'Product Aproved',
                                'moderationpanel' => 'Moderation Panel',
                            ],
                            'salesmanager',
                            ['required', 'id' => 'admintype', 'class' => 'form-control'],
                        ) !!}
                    </div>
                    <div class="mb-3">
                        {!! Form::label('status', 'Status *') !!}
                        {!! Form::select('status', ['Active' => 'Active', 'Pending' => 'Pending', 'Reject' => 'Reject'], null, [
                            'required',
                            'id' => 'status',
                            'class' => 'form-control',
                        ]) !!}
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data) {
                            ...
                            $.each(data, function(key, value) {
                                $('#bikemodel_id').append('<option value="' + value.id +
                                    '">' + value.bikemodel + '</option>');
