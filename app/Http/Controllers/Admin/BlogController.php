 ...
 $schema='
{
  ...
  "dateModified":"'. date("Y-m-d").'"
     ...
     // dd($schema);exit;
        ...
        DB::commit();
         $data = [
            ...
            'superadminbody' => '<a class="black-text"  href="'. url('/superadmin/editblog/'.$list->id) . '">'.Auth::user()->name .' edit ' .$list->title. '</a>'
  ];
    ...
    public function destroy($id)
    {
        ...
        if($delete) {
            ...
            'superadminbody' =>  '<a class="black-text"  href="'. url('/superadmin/restore/'.$delete->id) . '">'.Auth::user()->name .' delete ' .$delete->title. '</a>'
  ];
   ...
   public function setapproval(Request $request){
        ...
        if($request->action=="allow"){
            ...
            'superadminbody' => '<a class="black-text"  href="'. url('/superadmin/editblog/'.$roomapproval->id) . '">'.Auth::user()->name .' Draft  ' .$roomapproval->title. '</a>'
  ];
 ...
 $data = [
            ...
            'superadminbody' => '<a class="black-text"  href="'. url('/superadmin/editblog/'.$roomapproval->id) . '">'.Auth::user()->name .' Publish ' .$roomapproval->title. '</a>'
  ];
