           ...
           $info= Buysms::create($request->all()+['admin_id'=>Auth::id()]);
                ...
                if($info){
                    $data = [
                        ...
                        'superadminbody' =>'<a class="black-text"  href="'. url('/superadmin/editsalesms/'.$info->id) . '">'. Auth::user()->name. ' Want To Buy SMS ' .$info->payamount .'TK</a>',
                ];
           ...
           $info= Buysms::find($id)->update($request->all()+['admin_id'=>Auth::id()]);
                ...
                if($info){
                    $data = [
                        ...
                        'superadminbody' =>'<a class="black-text"  href="'. url('/superadmin/editsalesms'.$id) . '">'. Auth::user()->name. ' Change  Buy SMS Info </a>',
                ];
