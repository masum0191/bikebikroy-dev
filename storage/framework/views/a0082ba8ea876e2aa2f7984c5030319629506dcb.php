<?php $__env->startSection('title','Recent Sports Bike'); ?>
  ...
  clearform();
        ...
        $('#dataTable').DataTable({
            ...
            ajax: {
                ...
                url: "<?php echo e(url('admin/recentsports')); ?>",
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data) {
                        Swal.fire({
                            icon: 'warning',
                            title: "Sports Ad is Active Successfully",
                                timer: 2000,
                                showConfirmButton: false,
                                });
                        $('#dataTable').DataTable().ajax.reload();
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bikebik/public_html/resources/views/admin/sale/recentsports.blade.php ENDPATH**/ ?>