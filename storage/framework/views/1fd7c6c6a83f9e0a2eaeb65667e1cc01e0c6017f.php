            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="banner-item text-center">
                        ...
                        <form action="<?php echo e(url('searchbike')); ?>" method="get" class="d-flex banner-src-form">
  ...
  <div class="container-fluid">
    ...
    <div class="container">
        ...
        <div class="similar-main">
            <div class="row">
                <?php $__currentLoopData = $recentbike; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bike1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                    <div class="col-md-3">
                        <div class="card ad-card-single border mb-0">
                            <a href="<?php echo e(url('bikesale/'.$bike1->slug)); ?>">
                                <img src="<?php echo e(url('storage/app/files/shares/uploads/'.$bike1->path.'/'.$bike1->photoone)); ?>" class="w-100 bike-post-list" height="150px" width="225px;" alt="<?php echo e($bike1->title); ?>" style="object-fit: cover;">
                                <div class="card-body">
                                    <h5 class="card-title">
                                        <?php if(Str::of($bike1->title)->wordCount()>2): ?>
                                        <?php echo e(substr($bike1->title, 0, 20) . '...'); ?>
                                    ...
                                    <h6 class="price">
                                       <?php echo e(number_format($bike1->price)); ?> BDT
                                    </h6>
                                    <p class="card-text mb-0"><?php $area=App\Models\Area::where('thana_id',$bike1->thana_id)->first(); ?><?php echo e(@$area->areaname); ?>, <?php echo e(@$bike1->thana->thana); ?>, <?php echo e(@$bike1->district->district); ?> </p>
    ...
    <div class="container">
        ...
        <div class="similar-main">
            <div class="row">
                <?php $__currentLoopData = $recentsports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bike2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>


                  <div class="col-md-3">
                        <div class="card ad-card-single border mb-0">
                            <a href="<?php echo e(url('bikesale/'.$bike2->slug)); ?>">
                                <img src="<?php echo e(url('storage/app/files/shares/uploads/'.$bike2->path.'/'.$bike2->photoone)); ?>" class="w-100 bike-post-list" height="150px" width="225px;" alt="<?php echo e($bike2->title); ?>" style="object-fit: cover;">
                                <div class="card-body">
                                    <h5 class="card-title">
                                        <?php if(Str::of($bike2->title)->wordCount()>2): ?>
                                        <?php echo e(substr($bike2->title, 0, 20) . '...'); ?>
                                    ...
                                    <h6 class="price">
                                       <?php echo e(number_format($bike2->price)); ?> BDT
                                    </h6>
                                    <p class="card-text mb-0"><?php $area=App\Models\Area::where('thana_id',$bike2->thana_id)->first(); ?><?php echo e(@$area->areaname); ?>, <?php echo e(@$bike2->thana->thana); ?>, <?php echo e(@$bike2->district->district); ?> </p>
    ...
    <div class="container">
        ...
        <div class="similar-main">
            <div class="row">
                <?php $__currentLoopData = $recentscooters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bike3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>


                <div class="col-md-3">
                        <div class="card ad-card-single border mb-0">
                            <a href="<?php echo e(url('bikesale/'.$bike3->slug)); ?>">
                                <img src="<?php echo e(url('storage/app/files/shares/uploads/'.$bike3->path.'/'.$bike3->photoone)); ?>" class="w-100 bike-post-list" height="150px" width="225px;" alt="<?php echo e($bike3->title); ?>" style="object-fit: cover;">
                                <div class="card-body">
                                    <h5 class="card-title">
                                        <?php if(Str::of($bike3->title)->wordCount()>2): ?>
                                        <?php echo e(substr($bike3->title, 0, 30) . '...'); ?>

                                        <?php else: ?>
                                        <?php echo e(substr($bike3->title, 0, 20) . '...'); ?> &#160 &#160 &nbsp  &#160 &#160 &#160 &#160.
                                        <?php endif; ?>
                                    
                                    </h5>
                                    <h6 class="price">
                                       <?php echo e(number_format($bike3->price)); ?> BDT
                                    </h6>
                                    <p class="card-text mb-0"><?php $area=App\Models\Area::where('thana_id',$bike3->thana_id)->first(); ?><?php echo e(@$area->areaname); ?>, <?php echo e(@$bike3->thana->thana); ?>, <?php echo e(@$bike3->district->district); ?> </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="category-tittle mb-0 text-end">
                                <a href="<?php echo e(url('all-brand')); ?>"> See All brand</a>
                            </p>
                        </div>
                    </div>
                    <div class="main-category">
                        <div class="row">
                            <?php $__currentLoopData = $Bikebrad; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($key < 12): ?>  
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laragon\www\bikebikroy\bike\bikebikroy-dev\bikebikroy-dev\resources\views/welcome.blade.php ENDPATH**/ ?>