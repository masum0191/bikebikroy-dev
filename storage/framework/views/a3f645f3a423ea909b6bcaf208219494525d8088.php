<?php $__env->startSection('title','User Shop'); ?>
...
<section id="product-main">
    ...
    <div class="row">
        <?php echo $__env->make('partial.formerror', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo Form::open(['url' => 'user/createshop','method'=>'POST','class' => 'row g-3', 'files'=>'true']); ?>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bikebik/public_html/resources/views/user/shop/create.blade.php ENDPATH**/ ?>