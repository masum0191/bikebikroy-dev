                ...
                <ul class="dash-main-menu">
                    ...
                    <li>
                        ...
                        <ul class="dash-main-menu layout-toggle">
                            <li><a href="<?php echo e(url('superadmin/adminlist')); ?>" class="<?php echo e((request()->is('superadmin/adminlist')) ? 'page-active' : ''); ?>"><i class="far fa-circle"></i> Admin List</a></li>
                            <li><a href="<?php echo e(url('superadmin/rolelist')); ?>" class="<?php echo e((request()->is('superadmin/rolelist')) ? 'page-active' : ''); ?>"><i class="far fa-circle"></i> Role List</a></li>
                    ...
                    <li>
                        ...
                        <ul class="dash-main-menu page-toggle">
                            ...
                            <li><a href="<?php echo e(url('superadmin/bikebrandlist')); ?>"  class="<?php echo e((request()->is('superadmin/bikebrandlist')) ? 'page-active' : ''); ?>"><i class="far fa-circle"></i>Bike Brand List</a></li>
                            <li><a href="<?php echo e(url('superadmin/bikemodellist')); ?>"  class="<?php echo e((request()->is('superadmin/bikemodellist')) ? 'page-active' : ''); ?>"><i class="far fa-circle"></i> Model List</a></li>
                    ...
                    <li>
                        ...
                        <ul class="dash-main-menu component-toggle">
                            <li><a href="<?php echo e(url('superadmin/packagelist')); ?>"  class="<?php echo e((request()->is('superadmin/packagelist')) ? 'page-active' : ''); ?>"><i class="far fa-circle"></i> Package List</a></li>
                            <li><a href="<?php echo e(url('filemanager')); ?>" target="_blank" class="<?php echo e((request()->is('filemanager')) ? 'page-active' : ''); ?>"><i class="far fa-circle"></i> File Manager</a></li>
                    ...
                    <li>
                        ...
                        <ul class="dash-main-menu component-toggle">
                            <li><a class="" href="<?php echo e(url('superadmin/autolocation')); ?>" class="<?php echo e((request()->is('superadmin/autolocation')) ? 'page-active' : ''); ?>"><i class="far fa-circle"></i> Auto Add Location</a></li>
                           <li><a href="<?php echo e(url('superadmin/commandlist')); ?>" class="<?php echo e((request()->is('superadmin/commandlist')) ? 'page-active' : ''); ?>"><i class="far fa-circle"></i> Command</a></li>
                           <li><a href="<?php echo e(url('superadmin/divisionlist')); ?>" class="<?php echo e((request()->is('superadmin/divisionlist')) ? 'page-active' : ''); ?>"><i class="far fa-circle"></i> Divison List</a></li>
                           <li><a href="<?php echo e(url('superadmin/districtlist')); ?>" class="<?php echo e((request()->is('superadmin/districtlist')) ? 'page-active' : ''); ?>"><i class="far fa-circle"></i> District List</a></li>
                           <li><a href="<?php echo e(url('superadmin/thanalist')); ?>" class="<?php echo e((request()->is('superadmin/thanalist')) ? 'page-active' : ''); ?>"><i class="far fa-circle"></i> Thana List</a></li>
                           <li><a href="<?php echo e(url('superadmin/arealist')); ?>" class="<?php echo e((request()->is('superadmin/arealist')) ? 'page-active' : ''); ?>"><i class="far fa-circle"></i> Area List</a></li>
...
$.ajax({
    ...
    <?php /**PATH /home/bikebik/public_html/resources/views/layouts/superadmin.blade.php ENDPATH**/ ?>