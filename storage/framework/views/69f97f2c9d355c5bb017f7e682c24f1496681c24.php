...
<?php $__env->startSection('title','Thana List'); ?>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <?php echo Form::open(['url' => 'superadmin/createpackage', 'class' => 'form', 'id' => 'ccccc']); ?>
                ...
                <?php echo Form::hidden('thanaid', '', ['id' => 'thanaid']); ?>

               
            <label for="district" class="form-label">Select District *</label>
            <div class="input-group">
                <?php echo Form::select('district_id',CommonFx::Districtname(),null, array('id'=>'district_id','required','class'=>'form-control','placeholder'=>'Select Division')); ?>

            </div>   
            <label for="thana" class="form-label">Thana Name English *</label>
              <div class="input-group">
                <?php echo Form::text('thana', null, ['id' => 'thana', 'class' => 'form-control  mb-1']); ?>

            </div> 
            <label for="bnthana" class="form-label">Thana Name Bangla *</label>
            <div class="input-group">
                <?php echo Form::text('bndistrict', null, ['id' => 'bnthana', 'class' => 'form-control  mb-1']); ?>
  ...
  clearform();
        ...
        $('#dataTable').DataTable({
            ...
            ajax: {
                ...
                url: "<?php echo e(url('superadmin/thanalist')); ?>",
...
$.ajax({
    url:"<?php echo e(url('/superadmin/createthana')); ?>",
    method: "POST",
    data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.superadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bikebik/public_html/resources/views/superadmin/location/thana.blade.php ENDPATH**/ ?>