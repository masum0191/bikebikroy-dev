...
.select2-container--default .select2-selection--single .select2-selection__rendered{
    ...
    <title><?php echo e(config('app.name', 'BikeBikroy')); ?></title>
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                <a class="navbar-brand py-0 me-0" href="<?php echo e(url('/')); ?>">
                   <img src="<?php echo e(asset('assets/images/bikebikroy-logo-1.png')); ?>" alt="" class="">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <li class="">
                        <a class="" href="<?php echo e(url('/bikesale')); ?>">All Ads</a>
                    </li>
                        ...
                        <div class="col-md-3">
                            <div class="footer-menu">
                                ...
                                <ul class="ps-0">
                                    ...
                                    <li><a href="<?php echo e(url('user/membership')); ?>">Membership</a></li>
...
<?php echo app('flasher.response_manager')->render(); ?>
 ...
 <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
  ...
  $('.js-example-basic-single').select2();
        ...
        </html><?php /**PATH /home/bikebik/public_html/resources/views/layouts/user.blade.php ENDPATH**/ ?>