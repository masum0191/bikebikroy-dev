...
<?php $__env->startSection('title','District List'); ?>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <?php echo Form::open(['url' => 'superadmin/createpackage', 'class' => 'form', 'id' => 'ccccc']); ?>
                ...
                <?php echo Form::hidden('districtid', '', ['id' => 'districtid']); ?>
            ...
            <label for="district" class="form-label">District Name English *</label>
              <div class="input-group">
                <?php echo Form::text('district', null, ['id' => 'district', 'class' => 'form-control  mb-1']); ?>

            </div> 
            <label for="bndistrict" class="form-label">District Name Bangla *</label>
            <div class="input-group">
                <?php echo Form::text('bndistrict', null, ['id' => 'bndistrict', 'class' => 'form-control  mb-1']); ?>
  ...
  clearform();
        ...
        $('#dataTable').DataTable({
            ...
            ajax: {
                ...
                url: "<?php echo e(url('superadmin/districtlist')); ?>",
...
$.ajax({
    url:"<?php echo e(url('/superadmin/createdistrict')); ?>",
    method: "POST",
    data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.superadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bikebik/public_html/resources/views/superadmin/location/district.blade.php ENDPATH**/ ?>