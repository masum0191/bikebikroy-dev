        ...
        <div class="row">
            <div class="col-md-12">
                <h3 class="ad-post-head mb-0 pt-5 text-center">
                    Welcome <?php echo e(Auth::user()->fullname); ?> Let's Quick Posting.
                </h3>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="product-share">
                                <ul class="mb-0 ps-0">
                                    <li><a href="/user/dashboard" class="text-primary">Your All Ad</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="ad-form mb-5" style="border: 1px solid gray;background: lightgray;">
                        <?php echo Form::open(['url' => 'user/quickstore', 'class' => 'row g-3', 'files'=>'true']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bikebik/public_html/resources/views/user/bikesale/quicksale.blade.php ENDPATH**/ ?>