      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="input-group">
                <?php echo Form::text('packagename', null, ['id' => 'packagename', 'class' => 'form-control  mb-1']); ?>

            </div> 
            <label for="packageprice" class="form-label">Package Price *</label>
            <div class="input-group">
                <?php echo Form::number('packageprice', null, ['id' => 'packageprice', 'class' => 'form-control  mb-1']); ?>

            </div>
            <label for="expiryday" class="form-label">Expiry Day *</label>
            <div class="input-group">
                <?php echo Form::number('expiryday', null, ['id' => 'expiryday', 'class' => 'form-control  mb-1']); ?>

            </div>
           
            <label for="description" class="form-label">Description  </label>
            <div class="input-group">
                <?php echo Form::text('description', null, ['id' => 'description', 'class' => 'form-control  mb-1']); ?>
  ...
  clearform();
        ...
        $('#dataTable').DataTable({
            ...
            ajax: {
                ...
                url: "<?php echo e(url('superadmin/packagelist')); ?>",
...
$.ajax({
    url:"<?php echo e(url('/superadmin/createpackage')); ?>",
    method: "POST",
    data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.superadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bikebik/public_html/resources/views/superadmin/package/index.blade.php ENDPATH**/ ?>