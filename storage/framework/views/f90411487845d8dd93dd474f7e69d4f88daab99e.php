<?php $__env->startSection('title','Bike Sale'); ?>
        ...
        <div class="row">
            <div class="col-md-12">
                <h3 class="ad-post-head mb-0 pt-5 text-center">
                    Welcome <?php echo e(Auth::user()->fullname); ?> Let's posting .
                </h3>
            </div>
        </div>
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="ad-form">
                        <?php echo Form::open(['route' => 'bikesale.store', 'class' => 'row g-3', 'files'=>'true']); ?>
                      ...
                      <div class="col-md-4">
                            ...
                            <div class="col-12">
                               ...
                               <div class="col-12">
                                ...
                                <?php echo Form::number('year',null,   array('id'=>'year','required','class'=>'form-control','placeholder'=>'Ex: Year of Bike Year ?')); ?>
                            ...
                            <h5 class="text-center">Perfect image size should be 560 x 368 pixels within or equal to 20 mb </h5>
                            <div class="col-3">
...
<div id="modal" class="modal">
        <div class="modal-content">
            ...
            <p>File size exceeds 20 MB! Please select a different file.</p>
        </div>
    </div>
...
['image1', 'image2', 'image3', 'image4'].forEach(id => {
    document.getElementById(id).addEventListener('change', checkFileSize);
});
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bikebik/public_html/resources/views/user/bikesale/bikesale.blade.php ENDPATH**/ ?>