            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="ad-form mb-5" style="border: 1px solid gray;background: lightgray;">
                        <?php echo Form::open(['url' => 'quickadstore', 'class' => 'row g-3', 'files'=>'true']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bikebik/public_html/resources/views/user/bikesale/quickad.blade.php ENDPATH**/ ?>