...
<section id="account-menu">
    <div class="container">
        <ul class="ac-menu ps-0 mb-0">
            ...
            <li><a  style="color: #000;" href="<?php echo e(url('user/profile')); ?>">My account</a></li>
            <li><a href="<?php echo e(url('user/membership')); ?>">My membership</a></li>
            <li><a href="<?php echo e(url('user/addshop')); ?>">Shop</a></li>
            <li><a href="<?php echo e(url('user/dashboard')); ?>">My dashboard</a></li>
        </ul>
    </div>
</section>
                        ...
                        <div class="col-md-12">
                            <div class="ac-user-name">
                                <p>
                                    ...
                                    <img width="80px" height="80px" src="<?php echo e(url('storage/app/files/shares/uploads/'.@Auth::user()->path.'/'.@Auth::user()->photo)); ?>" alt="no-photo">
                                </p>
                            </div>
                            <?php echo Form::open(['url' => 'user/uploadphoto','method'=>'POST','class' => 'row g-3', 'files'=>'true']); ?>
                            ...
                            <form class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-check ps-0">
                                     ...
                                     <p class="mb-0"><b><?php echo e(@Auth::user()->phone); ?></b></p>
                                    </div>
                                    <?php else: ?>
                                    <div class="col-12">
                                        <label for="phone" class="form-label">Phone Number *</label>
                                   <input type="tel" required id="phone" value="<?php echo e(@Auth::user()->phone); ?>" class="form-control" max="13"/> 
                                    </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="fullname" placeholder="Auto-fill" value="<?php echo e(Auth::user()->fullname); ?>">
                                </div>
                                <div class="col-md-6">
...
$(document).ready(function () {
    ...
    var thanaid = '<?php echo (auth()->user()->thana_id); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bikebik/public_html/resources/views/user/profile.blade.php ENDPATH**/ ?>