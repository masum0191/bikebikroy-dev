...
<?php $__env->startSection('title','Bike Model List'); ?>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <?php echo Form::open(['url' => 'superadmin/createpackage', 'class' => 'form', 'id' => 'ccccc']); ?>
                ...
                <?php echo Form::hidden('bikemodeldid', '', ['id' => 'bikemodeldid']); ?>

                <label for="district" class="form-label">Select Bike Brand *</label>
            <div class="input-group">
                <?php echo Form::select('bikebrand_id',CommonFx::BikeBrand(),null, array('id'=>'bikebrand_id','required','class'=>'form-control','placeholder'=>'Select Bikebrand')); ?>

            </div>   
            <br>
            <label for="bikemodel" class="form-label">Bike Model Name English *</label>
            <div class="input-group">
                <?php echo Form::text('bikemodel', null, ['id' => 'bikemodel', 'class' => 'form-control  mb-1']); ?>

            </div> 
            <label for="bnbikemodel" class="form-label">Bike Model Name Bangla *</label>
            <div class="input-group">
                <?php echo Form::text('bnbikemodel', null, ['id' => 'bnbikemodel', 'class' => 'form-control  mb-1']); ?>
  ...
  clearform();
        ...
        $('#dataTable').DataTable({
            ...
            ajax: {
                ...
                url: "<?php echo e(url('superadmin/bikemodellist')); ?>",
...
$.ajax({
    url:"<?php echo e(url('/superadmin/createbikemodel')); ?>",
    method: "POST",
    data: {
...
$.ajax({
    ...
    success: function(d) {
        if (d.success) {
            Swal.fire({
            icon: 'success',
            title: "Bikemodel Update Successfully",
                timer: 2000,
                showConfirmButton: false,
                });
            $('#dataTable').DataTable().ajax.reload();
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.superadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bikebik/public_html/resources/views/superadmin/bike/bikemodel.blade.php ENDPATH**/ ?>